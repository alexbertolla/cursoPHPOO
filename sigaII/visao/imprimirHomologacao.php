...
<html>
    ...
    <body >
        ...
        <h2 class="titulo">Homologação</h2>
        ...
        <div id="divInfoDocumento">
            <blockquote>
                O presente processo trata de contratação pela melhor proposta de empresa(s) para o fornecedimento de:
                <p><b><?= nl2br($processo->getObjeto()) ?></b></p>
                para o CNPAT, conforme exigência do Edital, teve sua tramitação atendida de acordo com a Lei de Licitaçẽos.
                Desse modo, satisfazendo a Lei e ao Mérito, HOMOLOGO a citada Licitação.
            </blockquote>
        </div>
